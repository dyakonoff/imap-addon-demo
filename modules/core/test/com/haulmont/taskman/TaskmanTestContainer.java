...
public class TaskmanTestContainer extends TestContainer {

    public TaskmanTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/haulmont/taskman/app.properties",
    ...
    public static class Common extends TaskmanTestContainer {

        public static final TaskmanTestContainer.Common INSTANCE = new TaskmanTestContainer.Common();
